...
html_short_title = 'Bosting Housing Data'
...
latex_documents = [
  ('index', 'boston_housing.tex', basename,
   u'Russell Nakamura', 'howto'),
]
...
texinfo_documents = [
  ('index', basename, basename + u' Documentation',
   u'Russell Nakamura', basename, basename + ' Tester.',
   'Miscellaneous'),
]
...
autodoc_member_order = ['imported-members']
